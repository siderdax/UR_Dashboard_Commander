...
{
  new (message_memory) ur_dshbd_msgs::msg::Command(_init);
}

void Command_fini_function(void * message_memory)
{
  auto typed_message = static_cast<ur_dshbd_msgs::msg::Command *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Command_message_member_array[2] = {
  {
    ...
    offsetof(ur_dshbd_msgs::msg::Command, command),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ur_dshbd_msgs::msg::Command, data),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Command_message_members = {
  ...
  2,  // number of fields
  sizeof(ur_dshbd_msgs::msg::Command),
...
{
  return &::ur_dshbd_msgs::msg::rosidl_typesupport_introspection_cpp::Command_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ur_dshbd_msgs, msg, Command)() {
  return &::ur_dshbd_msgs::msg::rosidl_typesupport_introspection_cpp::Command_message_type_support_handle;
}
