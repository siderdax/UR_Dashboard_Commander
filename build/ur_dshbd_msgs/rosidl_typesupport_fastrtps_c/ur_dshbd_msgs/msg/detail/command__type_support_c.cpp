...
#include "ur_dshbd_msgs/msg/detail/command__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // command, data
#include "rosidl_runtime_c/string_functions.h"  // command, data

// forward declare type support functions


using _Command__ros_msg_type = ur_dshbd_msgs__msg__Command;
...
size_t get_serialized_size_ur_dshbd_msgs__msg__Command(
  const void * untyped_ros_message,
...
static uint32_t _Command__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ur_dshbd_msgs__msg__Command(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ur_dshbd_msgs
size_t max_serialized_size_ur_dshbd_msgs__msg__Command(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ur_dshbd_msgs__msg__Command;
    is_plain =
      (
...
static size_t _Command__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ur_dshbd_msgs__msg__Command(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ur_dshbd_msgs, msg, Command)() {
