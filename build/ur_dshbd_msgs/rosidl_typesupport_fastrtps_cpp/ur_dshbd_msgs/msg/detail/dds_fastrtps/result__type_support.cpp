...
#include "ur_dshbd_msgs/msg/detail/result__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ur_dshbd_msgs::msg::Result;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ur_dshbd_msgs::msg::Result *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ur_dshbd_msgs::msg::Result *>(
    untyped_ros_message);
...
{
  return &ur_dshbd_msgs::msg::typesupport_fastrtps_cpp::_Result__handle;
}
