...
static const _Result_type_support_symbol_names_t _Result_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ur_dshbd_msgs, msg, Result)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ur_dshbd_msgs, msg, Result)),
  }
};
...
{
  return &::ur_dshbd_msgs::msg::rosidl_typesupport_cpp::Result_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ur_dshbd_msgs, msg, Result)() {
  return get_message_type_support_handle<ur_dshbd_msgs::msg::Result>();
}
