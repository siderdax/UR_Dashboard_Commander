...
bool ur_dshbd_msgs__msg__command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ur_dshbd_msgs.msg._command.Command", full_classname_dest, 34) == 0);
  }
  ur_dshbd_msgs__msg__Command * ros_message = _ros_message;
  {  // command
...
PyObject * ur_dshbd_msgs__msg__command__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ur_dshbd_msgs.msg._command");
